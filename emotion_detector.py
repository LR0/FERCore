...
from face_detector import get_biggest_face
...
class EmotionDetector:
    def __init__(self, labels=get_labels('fer2013'), face_detector=dlib.get_frontal_face_detector(),
    ...
    def detect_biggest(self, bgr_image):
        ...
        gray_face, coord = get_biggest_face(gray_image, emotion_offsets)
